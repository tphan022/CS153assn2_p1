...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 d0 0a 00 	movl   $0xad0,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	0f b6 80 20 0b 00 00 	movzbl 0xb20(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 578:	75 27                	jne    5a1 <printf+0x120>
          s = "(null)";
 57a:	c7 45 e4 ec 0a 00 00 	movl   $0xaec,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 647:	a1 40 0b 00 00       	mov    0xb40,%eax
...
free(void *ap)
{
 ...
 708:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 70d:	c9                   	leave  
 70e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75b:	e8 d8 fe ff ff       	call   638 <free>
  return freep;
 760:	a1 40 0b 00 00       	mov    0xb40,%eax
}
 765:	c9                   	leave  
 766:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 779:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 77c:	a1 40 0b 00 00       	mov    0xb40,%eax
 781:	89 45 f0             	mov    %eax,-0x10(%ebp)
 784:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 788:	75 23                	jne    7ad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78a:	c7 45 f0 38 0b 00 00 	movl   $0xb38,-0x10(%ebp)
 791:	8b 45 f0             	mov    -0x10(%ebp),%eax
 794:	a3 40 0b 00 00       	mov    %eax,0xb40
 799:	a1 40 0b 00 00       	mov    0xb40,%eax
 79e:	a3 38 0b 00 00       	mov    %eax,0xb38
    base.s.size = 0;
 7a3:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 7aa:	00 00 00 
  }
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8ec:	c7 44 24 04 f3 0a 00 	movl   $0xaf3,0x4(%esp)
 8f3:	00 
 ...
 931:	c7 44 24 04 01 0b 00 	movl   $0xb01,0x4(%esp)
 938:	00 
 ...
 95d:	c7 44 24 04 0e 0b 00 	movl   $0xb0e,0x4(%esp)
 964:	00 
...
int random(int max){
 ...
 97b:	a1 34 0b 00 00       	mov    0xb34,%eax
 980:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 986:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 98b:	a3 34 0b 00 00       	mov    %eax,0xb34
    return (int)(rands % max);
 990:	a1 34 0b 00 00       	mov    0xb34,%eax
